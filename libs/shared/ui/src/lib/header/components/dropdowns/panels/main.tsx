...
import { useTheme } from 'coleccionablespanama/shared/theme'
...
const themeOptions = [
  {
    name: 'Modo claro',
    description: 'Ajusta la apariencia a modo claro normal.',
    icon: SunIcon,
    theme: 'light'
  },
  {
  ...
  },
  {
    name: 'Sistema',
    description:
      'Ajustaremos automáticamente la pantalla según la configuración de tu dispositivo.',
    icon: BrushIcon,
    theme: 'system'
  }
]
            ...
            >
                ...
                >
                  ...
                  >
                    <>
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium">Gestión de Cuenta</p>
                        <p className="text-xs text-neutral-400">
              ...
              {activeMenu === 'settings' && (
                <motion.div
                  ...
                  className="relative grid grid-cols-1 gap-1 p-1"
                >
                  <DropdownBack goToMenu="main">Configuración</DropdownBack>
                  <DropdownItem leftIcon={Bars3Icon}>Perfil</DropdownItem>
                  <DropdownItem leftIcon={Bars3Icon}>
                    Notificaciones
                  </DropdownItem>
                  <DropdownItem leftIcon={Bars3Icon}>Privacidad</DropdownItem>
                  <DropdownItem leftIcon={Bars3Icon}>Preferencias</DropdownItem>
                </motion.div>
              )}
              {activeMenu === 'help' && (
                <div
                ...
                >
                  ...
                  <DropdownItem leftIcon={Bars3Icon}>Soporte</DropdownItem>
                  <DropdownItem leftIcon={Bars3Icon}>
              ...
              {activeMenu === 'appearance' && (
                <div
                  ...
                  className=" grid grid-cols-1 gap-1 p-1"
                >
                  <DropdownBack goToMenu="main">Apariencia</DropdownBack>
