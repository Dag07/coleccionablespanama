...
import { useDebounce, useOnClickOutside } from 'coleccionablespanama/usehooks'
import { useAsync, getSearchResult } from 'coleccionablespanama/shared/api'
import {
  ...
  const onClickItem = useCallback(() => {
    ...
    if (item) {
      ...
      switch (item.result_type) {
        ...
        case 'asset':
          return push(`/items/${item?.searchable?.slug}`)
        case 'user':
      ...
      <div className="flex items-center">
        <div className="h-[50px] w-full">
          ...
          <input
            ...
            name="search"
            id="search"
            aria-label="Buscar en Coleccionables Panamá"
            ...
            placeholder="Busca artículos, colecciones, usuarios o paquetes"
          />
          {/* { !focused && ( */}
          <motion.div
            initial="visible"
