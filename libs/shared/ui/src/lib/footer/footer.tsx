            ...
            <div className="mb-10 w-full">
              ...
              >
                <div className="m-t font text-4xl font-extrabold tracking-tight text-slate-900  dark:text-slate-50  sm:text-4xl">
                  Coleccionables Panamá
                </div>
              </Link>
              <p className="text-body-color mb-7 text-base">
                Mercado de coleccionables auténticos: monedas antiguas, cartas
                Pokémon y más.
              </p>
              <span className="my-3 flex flex-row font-medium">
                Hecho con <span className="mx-1 text-yellow-500">♥</span> en
                Panamá
              </span>
            </div>
          </div>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <Link
                  href="https://www.facebook.com/coleccionablespanama.official"
                  rel="nofollow noopener"
                  target="_blank"
                ...
                <Link
                  href="https://www.twitter.com/coleccionablespanama.official"
                  rel="nofollow noopener"
                  target="_blank"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
              ...
              <p className="text-body-color text-base">
                &copy; 2025 Coleccionables Panamá
              </p>
            </div>
          </div>
        </div>
