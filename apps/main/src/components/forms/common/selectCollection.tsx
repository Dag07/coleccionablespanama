import {
  ...
  useOnScreen
} from 'coleccionablespanama/usehooks'
import { RadioGroup } from '@headlessui/react'
import { ChevronLeftIcon, ChevronRightIcon } from '@heroicons/react/24/outline'
import { ImageIcon } from '@remixicons/react/line'
import { api } from 'coleccionablespanama/shared/api'
...
// TODO extend exist types from coleccionablespanama/shared/api
...
const SelectCollection = ({ initial, onChange }: Props): JSX.Element => {
  ...
  const fetchData = async () => {
    ...
    const response = await api.get<ResponceProps>(
      'user/0xcoleccionablespanamaandrew/collections'
    )
