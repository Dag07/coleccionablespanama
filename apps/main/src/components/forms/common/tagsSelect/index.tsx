...
import { useAsync } from 'coleccionablespanama/shared/api'
import { getPopularTags } from 'coleccionablespanama/shared/api'
import { TagType } from 'coleccionablespanama/shared/types'
    ...
    <div className="flex flex-col">
      ...
      {!!filteredPopularTags.length && (
        <div className="flex flex-col">
          ...
          <motion.div
            layout
            className="col-auto -mt-2.5 flex flex-wrap gap-2.5"
          >
            {filteredPopularTags?.map((record) => (
              ...
              >
                <div className="duration-250 box-border flex flex-shrink-0 cursor-pointer touch-manipulation select-none items-center justify-center rounded-full bg-neutral-200 px-3 py-1 decoration-0 outline-none transition ease-in-out hover:bg-blue-100 dark:bg-neutral-700 dark:text-gray-200 dark:hover:bg-neutral-600">
                  {record.name}
                </div>
              </motion.div>
            ))}
