...
import { getTagsBySearch, useAsync } from 'coleccionablespanama/shared/api'
import {
    ...
    <div className={classNames('relative my-2 flex flex-wrap ')}>
      <motion.div
        ...
        className={classNames(
          'duration-250 flex w-full flex-wrap gap-2 rounded-md border p-1.5 transition ease-in-out',
          {
