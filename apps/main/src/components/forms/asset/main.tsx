...
import { UploaderPlaceholder } from 'coleccionablespanama/shared/ui'
...
const Uploader = dynamic<UploaderPropsType>(
  () => import('coleccionablespanama/uploader').then((mod) => mod.Uploader),
        ...
        >
          ...
          >
            ...
            <div className="text-lg font-bold">
              ¡Felicidades! Tu coleccionable fue{' '}
              {defaultAsset?.file_id ? 'actualizado' : 'subido'}!
            </div>
              ...
              {!defaultAsset?.file_id && (
                <Link href="/asset/create">
                  <a className="relative inline-block text-center bg-blue-600 border border-transparent rounded-md py-2 px-4 font-medium text-white hover:bg-blue-700">
                    Continuar con el artículo creado para publicar
                  </a>
                </Link>
              )}
            </div> */}
