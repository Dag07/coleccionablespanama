...
const SelectStep4 = ({
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="my-5">
        <p className="text-sm">
          Revisaremos si el archivo contiene alguna infracción que pueda
          restringir su publicación. Si el archivo no cumple con los requisitos,
      ...
      <div>
        <p className="text-xs text-neutral-400">
          Ten en cuenta que esta es solo una revisión preliminar durante la
          carga. Si existen infracciones en tu archivo, podrían detectarse más
          adelante.
