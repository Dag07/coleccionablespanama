...
import { CollectionType } from 'coleccionablespanama/shared/types'
              ...
              <>
                ...
                <div className="item-card-body">
                  <div className="item-card-content">
                    ...
                    <div>
                      <span>Total de Artículos: {item.supply}</span>
                    </div>
                    <div>
                      <span>Artículos Listados: {item.listed_count}</span>
                    </div>
                    <div>
                      <span>Volumen de Ventas: {item.sales_volume} ICP</span>
                    </div>
                    <div>
                      <span>Categoría: {item.blockchain || 'Sin definir'}</span>
                    </div>
                  </div>
