import { useAsync, getAssetOwners } from 'coleccionablespanama/shared/api'
import { useRouter } from 'next/router'
import { AssetOwnersResponseType } from 'coleccionablespanama/shared/types'
        ...
        >
          <div className="inline-flex items-center justify-start space-x-4">
            ...
            <div className="inline-flex flex-col items-start justify-start space-y-0.5">
              <p className="text-sm leading-normal text-gray-500">Creador</p>
