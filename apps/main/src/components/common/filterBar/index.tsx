...
import { useOnClickOutside } from 'coleccionablespanama/usehooks'
import {
  ItemValueProps,
  ArrayProps,
  RangeProps,
    ...
    <div className="flex flex-col">
      <div>
        <div className="flex w-full flex-row">
          <div className="relative inset-0 left-0 flex h-12 w-8 items-center py-2 sm:w-10">
            <div
          ...
          <div className="ml-1.5 flex w-full flex-1 sm:ml-2.5">
            <motion.div className="m-1.5 flex flex-1 flex-wrap items-center gap-2 sm:m-2">
              {renderTags}
              <motion.div
                key="input"
                layout
              ...
              >
                <input
                  ...
                  name="search"
                  id="search"
                  className="block w-full rounded-lg border-2 border-transparent bg-transparent px-2 py-2 text-base ring-0 transition duration-200 hover:border-transparent focus:border-transparent focus:ring-0 focus:ring-offset-0 dark:border-transparent dark:hover:border-transparent dark:focus:border-transparent sm:py-1 sm:text-sm md:text-base"
                  placeholder="Filtrar"
