...
import { useAsync, getBundles } from 'coleccionablespanama/shared/api'
import {
  BundleType,
...
import { GetBundlesFiltersParamsType } from 'coleccionablespanama/shared/types'
...
const Bundles = () => {
  ...
  return (
    <MainLayout
      title={'Paquetes | Mercado de coleccionables'}
      description={
        'Explora paquetes curados de monedas, Pokémon y otros artículos en Panamá.'
      }
      className="px-0"
    >
      <motion.div
      ...
      >
        ...
        <p className="mt-4 text-3xl tracking-tight text-slate-900 dark:text-gray-50">
          Descubre paquetes populares de artículos de colección en Panamá.
        </p>
      </motion.div>
