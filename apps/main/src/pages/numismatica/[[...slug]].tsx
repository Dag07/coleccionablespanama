...
const NumismaticaPage = () => {
  ...
  // Fixed category for numismatica
  const CATEGORY = 'Monedas'
  ...
  const [localFiltersState, setLocalFiltersState] = useState<QueryFiltersProps>(
    {
      ...
      filters: {
        blockchain: [CATEGORY], // Always filter by Monedas
        ...params.filters
      },
      sort: params.sort
    }
  ...
  return (
    <MainLayout
      ...
      description="Compra y vende monedas coleccionables en Panamá"
      className="px-0"
    >
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h1 className="mb-6 text-3xl font-bold text-gray-900 dark:text-white">
            Numismática - Monedas Coleccionables
          </h1>

          {/* Filter Bar */}
          <div className="mb-6">
            <FilterBar
              filters={COINS_FILTERS}
